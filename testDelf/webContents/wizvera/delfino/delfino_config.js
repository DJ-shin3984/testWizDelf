...
DelfinoConfig.cg.VPCGClientConfig = {
    ...
    // 표시할 Provider 설정: ,로 구분된 Provider name 순서대로 정렬됨: delfino, kakao, kakaotalk, toss, naver2, pass, payco, fincert, fincertcorp 가능
    displayProviders: 'delfino,kakao,kakaotalk,toss,naver2,pass,payco,fincert',
    ...
    providerTerms: {
        ...
        servieAgreementUrl: 'terms/serviceAgreement.jsp',           // 서비스 이용약관 동의
...
if (_Delfino_NotUseJsp) DelfinoConfig.cg.VPCGClientConfig.serviceUrl = DelfinoConfig.cg.VPCGClientConfig.serviceUrlServlet;
if (_Delfino_SystemMode == "test" || _Delfino_SystemMode == "dev" ) {
...
if (document.location.hostname.indexOf("2.wizvera.com") >= 0) {
    ...
    DelfinoConfig.cg.VPCGClientConfig.displayProviders = "delfino,kakao,toss,naver2,pass,payco,fincert,fincertcorp";
