...
<%
	...
	String expectFormattedText = (String)session.getAttribute("confirmSign.formattedText");
	if(!signedRawData.equals(expectFormattedText)){
...
<li>서명원문 : [<%=signedRawData%>] <%=signedRawData.length()%></li>
<li>expected 서명원문: [<%=expectFormattedText%>] <%=expectFormattedText.length()%></li>
