...
<body>
	...
	<form name="signFileUrlForm">
		...
		<li>다운로드: <input type="text" name="down_url" value="/wizvera/delfino/demo/tbsFileDownload.jsp?file=dump.pdf" style="width:480px;"/></li>
		<li>업로드: <input type="text" name="up_url" value="/wizvera/delfino/demo/fileUpload.jsp" style="width:480px;"/></li>
