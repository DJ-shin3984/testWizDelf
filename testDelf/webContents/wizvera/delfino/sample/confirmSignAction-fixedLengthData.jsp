...
<%
	...
	try {
		signVerifierResult = signVerifier.verifyPKCS7WithUserConfirm(signData, confirmSignData, "euc-kr", expectFormat, certStatusCheckType);
...
<%=com.wizvera.crypto.PKCS7Dump.dumpAsString(confirmSignData)%>
</pre>
</div>
