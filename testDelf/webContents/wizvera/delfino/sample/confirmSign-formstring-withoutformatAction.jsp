...
<%
	...
	try {	
		p7helper = new PKCS7Verifier(signData, charset);
	...
	String expectData= (String)session.getAttribute("confirmSign." + data);
	if(!signedRawData.equals(expectData)){
...
<li>expected 서명원문: [<%=expectData%>] <%=expectData.length()%></li>
