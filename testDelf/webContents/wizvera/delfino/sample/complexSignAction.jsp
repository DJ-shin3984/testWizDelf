...
<%@ page import="com.wizvera.json.JSONObject" %>
<%@ page import="com.wizvera.json.parser.JSONParser" %>
<%@ page import="com.wizvera.json.JSONArray" %>
...
<%
	...
	try {
        ...
        JSONArray jSignedData = (JSONArray) new JSONParser().parse(signedData);
        for (int i = 0; i < jSignedData.size(); i++) {
            ...
            JSONObject jError = (JSONObject) jSignItem.get("error");
