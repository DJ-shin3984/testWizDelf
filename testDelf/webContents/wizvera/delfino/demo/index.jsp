...
<%
    ...
    if (session.getAttribute("delfino_mobile_demo") == null) {
        ...
        if (request.getHeader("User-Agent").indexOf("Mobi")>=0) session.setAttribute("delfino_mobile_demo", "on");
    }
%>
...
<body>
    <h1>
        ...
        <font size=2><a href="./index.jsp">home</a></font>
    </h1>
