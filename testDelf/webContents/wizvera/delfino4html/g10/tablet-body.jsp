...
%>
    ...
    <div id="selectDialogTablet" style="display:none">
        <div id="selectDialogTabletBody"> 
            <div class="titleBarBlock">
                    ...
                    <div class="dolphinLogo"><img class="img" src="images/dolphin-logo_tablet_x2.png?<%=releaseDate%>" aria-label="델피노 로고"></div>
                    <div class="titleUnderline"></div>         
             </div>
            <div class="logoBlock">
                <img class="logo" src="images/wizvera-logo-tablet.png?<%=releaseDate%>" aria-label="로고이미지">
            </div>
    ...
    <div id="exportCertificateDialogTablet" style="display:none">
        <div id="extensionCertStoreDialogBodyTablet"> 
            <div class="titleBarBlock">
                    <div class="dialogTitle">전자 서명 작성</div>
                    <div class="dolphinLogo"><img class="img" src="images/dolphin-logo_tablet_x2.png?<%=releaseDate%>" aria-label="델피노 로고" aria-label="델피노 로고"></div>
                    <div class="titleUnderline"></div>         
             </div>
            <div class="logoBlock">
                <img class="logo" src="images/wizvera-logo-tablet.png?<%=releaseDate%>" aria-label="로고이미지">
            ...
            <div class="passwordBlock">
                <div class="passwordBorder">
                    <div class="passwordBlockInner">
                        <input class="passwordInput certificationPassword" type="password"/>
            ...
            <div class="passwordBlock">
                <div class="passwordBorder">
                    ...
                    <div class="passwordBlockInner createEasyPasswordCancelInput">
                        <label class="certPassword">인증서 비밀번호</label><input class="passwordInput easyPasswordDialogInput" aria-label="인증서 암호" alt="인증서 암호" name="easyPasswordDialogInput" type="password" autocomplete="off" disabled/><button class="keyboardButton" style="display: none"></button>
                    </div>
                    <div class='certpinContainer' style="display: none;">
                ...
                <div class="passwordMessageBorder">
                    ...
                    <div class="passwordInputBlock">
                        <div class="oldPasswordBlock">
                            ...
                            <input class="oldPasswordInput pwbox" type="password"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="passwordMessageBorder">
                    ...
                    <div class="passwordInputBlock">
                        ...
                        <div class="newPasswordConfirmBlock">
                            ...
                            <input class="newPasswordConfirmInput" type="password"/>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="authCodeDialogBody">
            ...
            <div class="authCodeContent">
                ...
                <div class="downBlock">
                    ...
                    <div class="image">
                        <img src="images/cert_import_roaming_x2_tablet.png" aria-label="인증서 가져오기 이미지">
                    </div>
    ...
    <div id="importLocalDialog" style="display:none">
        <div id="importLocalDialogBody">
            ...
            <div class="content">
                ...
                <img src="images/cert_search.png?<%=releaseDate%>" aria-label="인증서 설명 이미지">
                </div>
		...
		<fieldset id="providers-section" class="rightContent">
			...
			<div id="vpcg_content">
					...
					<form class='formData' name="vpcg_formLogin" onsubmit="return false;">
						...
						<div class="vpcg_terms">
							...
							<div class="privacy_terms">
								...
								<a href='#' class="privacy_terms_view" id="privacyView" target="_blank">보기></a>
							</div>
							<div class="info_terms">
								...
								<a href='#' class="info_terms_view" id="infoView" target="_blank">보기></a>
							</div>
						</div>
				...
				<div class="vpcg_section_wait vpcg_info_screen_normal">
					...
					<div class="vpcg_info_bottom_text">선택한 인증수단의 <span class="fs-13 color-06">모바일앱 알람</span>을 확인해주세요.</div>
				</div>
